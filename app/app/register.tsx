          ...
          >
            <View className="flex-1 justify-center items-center bg-green-50 px-4 py-8">
              ...
              <View className="bg-white w-full max-w-md rounded-xl shadow-lg p-8 items-center">
                <Text className="text-2xl font-bold mb-2 text-center">Create Account</Text>
                <Text className="text-gray-500 mb-6 text-center">Sign up to start your health journey</Text>
                {apiError ? (
                ...
                >
                  <Text className="text-white text-lg font-semibold">{loading ? "Registering..." : "Register"}</Text>
                </TouchableOpacity>
                {/* Sign In Link */}
