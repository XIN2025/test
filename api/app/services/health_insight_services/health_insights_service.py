...
from ...schemas.diagnosis import DiagnosisRequest, DiagnosisResult
from ...services.graph_db import get_graph_db
from ...services.mai_dxo_service import MAIDxOService
import logging
...
class HealthInsightsService:
    ...
    def get_health_insight(self, goal, context: list = None, user_email: str = None) -> HealthInsight:
        ...
        try:
            ...
            insight_llm = ChatOpenAI(model="gpt-5").with_structured_output(insight_schema)
